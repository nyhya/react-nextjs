 ...
 */
 ...
 (function(){
   ...
   //		throw new Error("Contents: can't mixin (oClass is invalid)");
   //	}
     var aPlugins = [];
   ...
   initIframe : function(){
     try {
       ...
       if (sCSSBaseURI){
         ...
         // mobile default font = noto sans , css 분리 210928
         if(this.oApp.bMobile) {
           linkNode.href = sCSSBaseURI + '/smart_editor2_in_m.css?v=1';
          } else {
           linkNode.href = sCSSBaseURI + '/smart_editor2_in.css?v=1';
         }
 ...
 */
 ...
 nhn.husky.SE2M_BGColor = jindo.$Class({
   ...
   _assignHTMLElements : function(elAppContainer){
     ...
     this._setLastUsedBGColor("#000000");
   },
